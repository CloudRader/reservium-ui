        ...
        <div className="min-h-screen bg-gradient-to-r from-green-50 to-green-100 py-16 md:py-4 lg:py-52">
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-stretch justify-between">
                <div className="bg-white dark:!bg-green-700 border-r-2 border-green-50 w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 p-6 md:p-8 text-center flex flex-col justify-center">
                    <h1 className="text-4xl dark:!text-white font-bold text-green-800 mb-4">404</h1>
                    <h2 className="text-2xl dark:!text-white font-semibold text-green-700 mb-6">Page Not Found</h2>
                    <p className="text-green-700 dark:text-white mb-8 font-medium">Oops! The page you're looking for doesn't exist.</p>
                    <NavLink
                        to="/"
