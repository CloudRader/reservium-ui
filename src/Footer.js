                        ...
                        <div className="mb-4 mr-6 md:mb-0">
                            ...
                            <div className="space-y-1 ml-1">
                                <a href="https://wiki.buk.cvut.cz/en/for-members/faq" target="_blank"
                                   ...
                                   className="text-green-600 hover:text-green-800 block">How to become a member</a>
                                <a href="https://wiki.buk.cvut.cz/cs/home" target="_blank" rel="noopener noreferrer"
                                   className="text-green-600 hover:text-green-800 block">Wiki</a>
                                <a href="https://wiki.buk.cvut.cz/cs/club-zone/club-room" target="_blank"
                                   rel="noopener noreferrer"
                                   className="text-green-600 hover:text-green-800 block">FAQ</a>
                                <a href="https://linktr.ee/bubenklub" target="_blank"
                                   rel="noopener noreferrer"
                                   className="text-green-600 hover:text-green-800 block">Links</a>
                            </div>
                        </div>
                        <div className="mb-4 mr-6 md:mb-0">
                            ...
                            <div className="space-y-1 ml-1">
                                <a href="https://www.instagram.com/bubenklub/" target="_blank"
                                   rel="noopener noreferrer"
                                   className="text-green-600 hover:text-green-800 block">Instagram</a>
                                <a href="https://discord.gg/cwb8mRD3Qg" target="_blank" rel="noopener noreferrer"
                                   className="text-green-600 hover:text-green-800 block">Discord</a>
                                <a href="https://t.me/+7HvQ_-rPlSxlZDcy" target="_blank" rel="noopener noreferrer"
                                   className="text-green-600 hover:text-green-800 block">Telegram</a>
                            </div>
                        </div>
                    </div>
                </div>
