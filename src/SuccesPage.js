            ...
            <div
                ...
                {isTooManyPeopleMessage ? (
                    <div className="w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 md:flex md:flex-col">
                        Now reservation is waiting for approval. For this type of reservation (more than 10 people) you
                        will need to get additional confirmation. More information here:
                    ...
                    <div>
                        <div className="w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 md:flex md:flex-col">
                            <div className="bg-white p-6 md:p-8 text-center flex-grow flex flex-col justify-center">
                                <h1 className="text-4xl font-bold text-green-800 mb-4">Reservation made
                                    successfully</h1>
                                <h2 className="text-2xl font-semibold text-green-700 mb-6">Reservation made
                                    successfully</h2>
                                <p className="text-green-700 mb-8">Now you can see it on the calendar.</p>
                                <p className="text-green-700 mb-8">Please read the terms of use for the spaces on our
                                    wiki.</p>
                                <div>
                                    <a href="https://wiki.buk.cvut.cz/cs/club-zone/club-room" target="_blank"
