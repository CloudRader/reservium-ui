...
const SuccessPage = () => {
    ...
    const processLocationState = (state) => {
        ...
        return {
            isTooManyPeopleMessage: message ? JSON.stringify(message).includes("more than") : false,
            isNightTimeMessage: message ? JSON.stringify(message).includes("Night time") : false,
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className="mb-8 text-center">
                                <p className="text-l md:text-xl text-green-700 mb-4">
                                    If you are reserving for {maxPeopleMessage}, you must fill out this registration form.
                                    It will be sent to the Head of Dormitory ({constants.headOfDormitoryEmail}), with the manager
                                    ({managerMail}) in CC.
                                </p>
                                <div className="pb-2">
                                    <a href={linkOnWiki}
